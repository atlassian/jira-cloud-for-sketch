...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(130)["setTimeout"]))
...
var _sketchModuleUserPreferences = __webpack_require__(339);
...
var keys = exports.keys = {
  ...
  return _sketchModuleUserPreferences2.default.getUserPreferences(_config.pluginName, (0, _lodash.mapValues)(keys, function () {
    return _NOT_SET;
  }));
}
...
function setUserPrefs(prefs) {
  _sketchModuleUserPreferences2.default.setUserPreferences(_config.pluginName, prefs);
}
...
function unset() /* [key, keys...] */{
  ...
  var prefs = getUserPrefs();
  prefs = (0, _lodash.mapValues)(prefs, function (value, key) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(340)(module)))
...
var _upgrade = __webpack_require__(135);
...
exports.default = function () {
  if ((0, _prefs.isSet)(_prefs.keys.addonUrl) && (0, _prefs.getString)(_prefs.keys.addonUrl) == oldBaseUrl) {
    (0, _prefs.setString)(_prefs.keys.addonUrl, newBaseUrl);
  }
};

var _prefs = __webpack_require__(93);

var oldBaseUrl = 'https://sketch.prod.atl-paas.net';
var newBaseUrl = 'https://sketch.atlassian.com';
...
exports.default = upgradeIfNeeded;
...
function upgradeIfNeeded() {
  var upgradeIndex = 0;
  if ((0, _prefs.isSet)(_prefs.keys.nextUpgradeIndex)) {
    upgradeIndex = (0, _prefs.getInt)(_prefs.keys.nextUpgradeIndex);
  }
  for (var i = upgradeIndex; i < tasks.length; i++) {
    try {
      tasks[i]();
      (0, _logger.trace)('Upgrade task ' + i + ' completed successfully');
    } catch (e) {
      (0, _logger.error)('Failed to execute upgrade task ' + i + ': ' + e);
      throw e;
    }
    (0, _prefs.setString)(_prefs.keys.nextUpgradeIndex, i + 1);
  }
}
module.exports = exports['default'];
