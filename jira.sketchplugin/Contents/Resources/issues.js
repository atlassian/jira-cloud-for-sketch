      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          { className: 'key', onClick: function onClick() {
              return (0, _client2.default)('viewIssue', issueKey);
            }, title: 'View issue' },
          issueKey
        ),
        (0, _preact.h)(
          ...
          { className: 'export', onClick: function onClick() {
              return (0, _client2.default)('exportAssets', issueKey);
            } },
          (0, _preact.h)('img', { src: 'export.png', title: 'Attach assets' })
        )
      );
    }
  }]);
...
var Issues = function (_Component2) {
  ...
  function Issues(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, (Issues.__proto__ || Object.getPrototypeOf(Issues)).call(this, props));
  ...
  _createClass(Issues, [{
    ...
    value: function render(props, _ref2) {
      ...
      return (0, _preact.h)(
        ...
        null,
        !ready && 'loading...',
        (issues || []).map(function (issueKey) {
          return (0, _preact.h)(Issue, { key: issueKey,
            issueKey: issueKey });
        })
      );
    }
...
(0, _preact.render)((0, _preact.h)(Issues, null), document.getElementById('container'));
